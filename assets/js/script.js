    ...
    success: function(result){
        console.log(result);
            $.each( result, function( i, val ) {
                if(val.type == 'dir'){
                    console.log('dir');
                    $('#affichage').append("<div data="+val.path+" class='block folder text-center col-xs-6 col-sm-6 col-md-3 col-lg-2'><img src='assets/img/sacclosed.png' width='110' height='145' ></br>" + val.name);
                }
                    ...
                    console.log('js');
                    $('#affichage').append("<div class='block text-center col-xs-6 col-sm-6 col-md-3 col-lg-2'><img src='assets/img/js.png' width='110' height='145' ></br>" + val.name);
                }
                    ...
                    console.log('jpg');
                    $('#affichage').append("<div class='block text-center col-xs-6 col-sm-6 col-md-3 col-lg-2'><img src='assets/img/jpg.png' width='110' height='145' ></br>" + val.name);
                }
                else if(val.extension == 'svg'){
                    console.log('svg');
                    $('#affichage').append("<div class='block text-center col-xs-6 col-sm-6 col-md-3 col-lg-2'><img src='assets/img/svg.png' width='110' height='145' ></br>" + val.name);
                }
                else if(val.extension == 'gif'){
                    console.log('gif');
                    $('#affichage').append("<div class='block text-center col-xs-6 col-sm-6 col-md-3 col-lg-2'><img src='assets/img/gif.png' width='110' height='145' ></br>" + val.name);
                }
                else
